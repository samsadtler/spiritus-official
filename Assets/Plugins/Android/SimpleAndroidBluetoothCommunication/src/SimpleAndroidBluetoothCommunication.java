...
public class SimpleAndroidBluetoothCommunication {
	...
	public String startCommunication(){
		stopCommunication();
		try{
	    	System.out.println("Sam, Create 1");
	    	int i = 0;
		    for (BluetoothDevice device : pairedDevices) {
		    	System.out.println("Sam, Create 2");
		    	System.out.println("Sam, DEVICE: " + device.toString());
		        UUID uuid = device.getUuids()[0].getUuid();
		    	System.out.println("Sam, Creating Socket... UUID: " + uuid.toString());
		        // Get a BluetoothSocket to connect with the given BluetoothDevice
		        try {
		            // MY_UUID is the app's UUID string, also used by the server code
		        	System.out.println("Sam,CREATING RFCOMM...");
		    	...
		    	System.out.println("Sam, Create 3");
		        try {
		            ...
		            try {
		            	...
		            	System.out.println("Sam, Socket closing Failed... " + closeException.toString());
		            }
		        }
	...
	public void writeChar(String deviceName, char val){
        System.out.println("Sam, WRITING TO " + deviceName);
        int i = -1;
        int j = 0;
	    for (BluetoothDevice device : pairedDevices) {
	    	System.out.println(device.getName());
	    	if(device.getName().trim().equals(deviceName)){
	    		System.out.println("Sam, DEVICE FOUND");
	    		i = j;
	    	}
	    	j++;
	    }
	    if(i == -1){
	    	System.out.println("Sam, Can't find: " + deviceName);
	    	return;
	    }
       	...
       	try{
        	...
        	System.out.println("Sam, ERROR WRITING: " + e.toString());
        }
	}
...
class CommunicationThread extends Thread {
    ...
    public void run() {
    	...
    	System.out.println("Sam, Connection Succeeded...");
        ...
        // member streams are final
        try {
        	System.out.println("Sam, Getting Output Stream");
